...
const getNavigation = (stats: any, notificationCounts: any): NavigationItem[] => [
  ...
  },
  {
    ...
    href: '/citizen/contracts-generation',
    icon: FileText,
    badge: stats?.totalContracts?.toString() || '0',
    children: [
      { name: 'Create New Contract', href: '/citizen/contracts-generation/create', icon: Plus },
      { name: 'View All Contracts', href: '/citizen/contracts-generation', icon: Eye },
      { name: 'Pending Signatures', href: '/citizen/contracts-generation/pending', icon: Clock, badge: notificationCounts?.signatures?.toString() || '0' },
      { name: 'Sent for Signing', href: '/citizen/contracts-generation/sent', icon: Send },
      { name: 'Signed Contracts', href: '/citizen/contracts-generation/signed', icon: CheckCircle },
    ],
  },
  {
    ...
    icon: Bot,
    children: [
      { name: 'Start Contract from Description', href: '/citizen/contracts-generation/create', icon: MessageCircle },
    ],
  },
  {
